    ...
    func testDecodeReal() throws {
        ...
        let expectedDataList = [
            Trim(
                ...
                price: 43460000,
                imageURL: URL(string: "https://h5-image.s3.ap-northeast-2.amazonaws.com/palisade/trim/leblanc_ios.png")!
            ),
            Trim(
                model: "펠리세이드",
                id: 2,
                ...
                price: 40440000,
                imageURL: URL(string: "https://h5-image.s3.ap-northeast-2.amazonaws.com/palisade/trim/exclusive_ios.png")!
            ),
            Trim(
                model: "펠리세이드",
                id: 3,
                ...
                price: 47720000,
                imageURL: URL(string: "https://h5-image.s3.ap-northeast-2.amazonaws.com/palisade/trim/prestige_ios.png")!
            ),
            Trim(
                model: "펠리세이드",
                id: 4,
                ...
                price: 52540000,
                imageURL: URL(string: "https://h5-image.s3.ap-northeast-2.amazonaws.com/palisade/trim/calligraphy_ios.png")!
            )
        ]
